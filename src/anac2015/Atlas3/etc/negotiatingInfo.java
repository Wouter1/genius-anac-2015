...
public class negotiatingInfo {		
    ...
    public void initOpponent(Object sender) {  
		...
		try { initOpponentsValueFrequency(sender); } // senderの頻度行列を初期化
		catch (Exception e) { 
    ...
    public void updateInfo(Object sender, Bid offeredBid) {    	
    	...
    	try { updateFrequencyList(sender, offeredBid); } // senderの頻度行列の更新
    	catch (Exception e) {
